...
while (page_no < 123):
    page_no += 1
    url = 'http://www.usnetads.com/category/0719-Shopping-Other-Shopping-Ads-page-{}.html'.format(page_no)
    ...
    ids.to_csv(r"C:\Users\HP\Desktop\USShopping.txt", header = None, index = None, sep = ',', mode='a', line_terminator=',\n')
